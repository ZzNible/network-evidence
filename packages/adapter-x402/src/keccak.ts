 ...
 *   2. Deriving the ERC-20 `Transfer(address,address,uint256)` event topic
 *      constant in tests (the runtime constant is a pinned literal; the test
 *      suite proves the derivation matches).
 *
